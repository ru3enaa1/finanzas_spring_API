...
public class GastoFijo {
    ...
    private Set<RegistroGastoFijo> registros = new LinkedHashSet<>();
    ...
    public Set<RegistroGastoFijo> getRegistros() {
        return registros;
    }

    public void setRegistros(Set<RegistroGastoFijo> registros) {
