...
@Entity
@Table(name = "presupuesto_periodo",
        uniqueConstraints = @UniqueConstraint(name = "uk_presupuesto_periodo_mes",
                columnNames = {"presupuesto_id", "anio", "mes"}))
public class PresupuestoPeriodo {
    ...
    @DecimalMin("0.00")
    @Column(name = "monto_limite_snapshot", precision = 12, scale = 2)
    private BigDecimal montoLimiteSnapshot = BigDecimal.ZERO;

    @NotNull
    @DecimalMin("0.00")
    @Column(name = "monto_gastado", nullable = false, precision = 12, scale = 2)
    ...
    public BigDecimal getMontoLimiteSnapshot() { return montoLimiteSnapshot; }
    public void setMontoLimiteSnapshot(BigDecimal montoLimiteSnapshot) { this.montoLimiteSnapshot = montoLimiteSnapshot; }
    ...
    public Boolean getAlertaGenerada() { return alertaGenerada; }
